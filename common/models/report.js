...
module.exports = function(Report) {
    ...
    Report.remoteMethod('dashboard', {
        accepts: [{
                ...
                type: 'string',
                required: false,
                description: "company id. If not set, get all"
            },
            {
                arg: 'from',
                type: 'string',
                required: false,
                description: "format: YYYY-MM-DD. If not set, default yesterday date"
            },
            {
                arg: 'to',
                type: 'string',
                required: false,
                description: "format: YYYY-MM-DD. If not set, default tomorrow date"
            }
        ],
